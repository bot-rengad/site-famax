...
// ============================================================
// Viewer 3D — tour de PC FMX, rendu sync à l'écran (rAF natif)
// ============================================================
function PcViewer({ fps, refreshHz, gameLabel }: { fps: number; refreshHz: number | null; gameLabel?: string }) {
  ...
  useEffect(() => {
    ...
    const glow = new THREE.Mesh(new THREE.CircleGeometry(0.9, 32), new THREE.MeshBasicMaterial({ color: 0xff1a1a, transparent: true, opacity: 0.045 }))
  ...
  return (
    <div ref={containerRef} className="relative flex min-h-[440px] items-center justify-center overflow-hidden rounded-[20px] border border-white/[0.08] bg-[#0a0a0c]">
  ...
  return (
    <section id="config" className="relative mx-auto max-w-[1280px] scroll-mt-24 px-5 py-16 lg:px-10">
      ...
      <div className="grid gap-7 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          <PcViewer fps={fps} refreshHz={refreshHz} gameLabel={`${game} • ${resolution}`} />
